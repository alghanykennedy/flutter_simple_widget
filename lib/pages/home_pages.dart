...
import 'package:flutter_simple_widget/models/category_model.dart';
import 'package:flutter_simple_widget/models/diet_model.dart';
import 'package:flutter_simple_widget/models/popular_model.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    _getInitialInfo();
    return Scaffold(
      appBar: appBar(context, title: 'Breakfast'),
